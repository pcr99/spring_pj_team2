...
public class UserAuthenticationService implements UserDetailsService {
	...
	*/
	...
	public UserDetails loadUserByUsername(String userId) throws UsernameNotFoundException {
		...
		UserInfoDTO dto = sqlSession.selectOne("spring.mvc.spring_pj_team2.dao.UserInfoDAO.selectUser", userId);
		...
		return new UserVO(dto.getUserId(), dto.getUserPwd(), dto.getEnabled().equals("1"),
